...
const BirdContent = ()=>{
    ...
    useEffect(()=>{
        cageValue && dispatch(getBirdData({pageNumber: pageNumber, pageSize: pageSize,cageId: cageValue}))
    ...
    {birds && birds.length > 0 ? birds.map(bird => <BirdCard key={bird.id} birdInfo={bird}/>) : <Stack direction='row' justifyContent={'center'}>
